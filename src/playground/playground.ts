...
playgroundGlobalUiState.scenes = ['main', 'railsCobweb', 'highPosEntityUpdates', 'floorRandom', 'lightingStarfield', 'transparencyIssue', 'entities', 'frequentUpdates', 'slabsOptimization', 'allEntities', 'geometryExport']
